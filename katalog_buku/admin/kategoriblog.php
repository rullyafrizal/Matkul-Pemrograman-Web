        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Daftar Kategori Blog
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        if (isset($_GET["katakunci"])) {
                            $katakunci_kategori_blog = $_GET["katakunci"];
                            $sql_jum .= " where `kategori_blog` LIKE '%$katakunci_kategori_blog%'";
                        }
                        ...
                        if (isset($_GET["katakunci"])) {
                            ...
                            $sql_k .= " where `kategori_blog` LIKE '%$katakunci_kategori_blog%'";
                        }
                        $sql_k .= " ORDER BY `id_kategori_blog` DESC limit $posisi, $batas ";
                        ...
                        while ($data_k = mysqli_fetch_row($query_k)) {
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="editkategoriblog.php?data=<?php echo $id_kategori_blog; ?>"
                                    ...
                                    'kategoriblog.php?aksi=hapus&data=<?php echo
                                    $id_kategori_blog; ?>&notif=hapusberhasil'" class="btn btn-xs btn-danger"><i
                    ...
                    <ul class="pagination pagination-sm m-0 float-right">
                        ...
                        if ($jum_halaman == 0) {
                            ...
                            if (isset($_GET["katakunci"])) {
                                $katakunci_kategori_blog = $_GET["katakunci"];
                                if ($halaman != 1) {
                                    echo "<li class='page-item'><a class='page-link' href='kategoriblog.php?katakunci=$katakunci_kategori_blog &halaman=1'>First</a></li>";
                                    echo "<li class='page-item'><a class='page-link' href='kategoriblog.php?katakunci=$katakunci_kategori_blog &halaman=$sebelum'>«</a></li>";
                                }
                                for ($i = 1; $i <= $jum_halaman; $i++) {
                                    if ($i > $halaman - 5 and $i < $halaman + 5) {
                                        if ($i != $halaman) {
                                            echo "<li class='page-item'><a class='page-link' 
                                                href='kategoriblog.php?katakunci
                                                =$katakunci_kategori_blog&halaman=$i'>
                                                $i</a></li>";
                                        } else {
                                ...
                                if ($halaman != $jum_halaman) {
                                    echo "<li class='page-item'><a class='page-link' href='kategoriblog.php?katakunci=$katakunci_kategori_blog&halaman=$setelah'>»</a></li>";
                                    echo "<li class='page-item'><a class='page-link'  href='kategoriblog.php?katakunci=$katakunci_kategori_blog&halaman=$jum_halaman'>Last</a></li>";
                                }
                            } else {
                                if ($halaman != 1) {
