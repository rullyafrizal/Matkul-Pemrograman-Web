...
if (empty($nama)) {
    header("Location:edituser.php?data=" . $id_user . "&notif=namaKosong");
} else if(empty($email)){
    header("Location:edituser.php?data=" . $id_user . "&notif=emailKosong");
} else if(empty($username)){
    header("Location:edituser.php?data=" . $id_user . "&notif=usernameKosong");
