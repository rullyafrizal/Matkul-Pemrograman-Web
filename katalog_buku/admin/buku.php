                        ...
                        while ($data_b = mysqli_fetch_row($query_k)) {
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="javascript:if(confirm('Anda yakin ingin menghapus buku <?php echo $judul; ?>?')) window.location.href = 'buku.php?aksi=hapus&data=<?php echo $id_buku; ?>¬if=hapusberhasil'"
