              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $tag; ?></td>
                    <td align="center">
                      <a href="edittag.php?data=<?php echo $id_tag; ?>" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i> Edit</a>
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $tag; ?>?'))window.location.href =
                                    'tag.php?aksi=hapus&data=<?php echo
              ...
              if ($jum_halaman == 0) {
                ...
                if (isset($_GET["katakunci"])) {
                  ...
                  for ($i = 1; $i <= $jum_halaman; $i++) {
                    ...
                    href='tag.php?katakunci
                    =$katakunci_tag&halaman=$i'>
                    $i</a></li>";
                      } else {
