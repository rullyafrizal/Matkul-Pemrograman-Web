...
if (isset($_SESSION['penerbit'])) {
    ...
    $alamat = $_POST['alamat'];
    if (empty($penerbit)) {
        header("Location:index.php?include=edit-penerbit&data=" . $id_penerbit . "&notif=editkosong&jenis=penerbit");
    } else if (empty($alamat)) {
        header("Location:index.php?include=edit-penerbit&data=" . $id_penerbit . "&notif=editkosong&jenis=alamat");
    } else {
