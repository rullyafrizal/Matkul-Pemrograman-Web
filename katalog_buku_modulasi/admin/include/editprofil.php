    ...
    <div class="card card-info">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="index.php?include=profil" class="btn btn-sm btn-warning float-right"><i
            ...
            if ((!empty($_GET['notif'])) && (!empty($_GET['jenis']))) {
                if ($_GET['notif'] == "editkosong") {
                    echo '<div class="alert alert-danger" role="alert">
                            Maaf data ' . $_GET['jenis'] . ' wajib diisi
                            </div>';
                }
            }
            ?>
        </div>
        <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-profil"
