            ...
            <table class="table table-bordered">
                ...
                while ($data_p = mysqli_fetch_row($query_p)) {
                    ...
                    <tr>
                        ...
                        <td><?= $alamat; ?></td>
                        <td align="center">
                            <a href="index.php?include=edit-penerbit&data=<?= $id_penerbit; ?>"
                   ...
                   'index.php?include=penerbit&aksi=hapus&data=<?= $id_penerbit; ?>&notif=hapusberhasil'"
            ...
            <ul class="pagination pagination-sm m-0 float-right">
                ...
                if ($jum_halaman == 0) {
                    ...
                    if ($halaman != 1) {
                        ...
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=penerbit&halaman=$sebelum'>«</a></li>";
                    }
