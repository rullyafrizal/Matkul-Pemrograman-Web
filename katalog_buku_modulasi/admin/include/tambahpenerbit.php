    ...
    <div class="card card-info">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="index.php?include=penerbit" class="btn btn-sm btn-warning float-right"><i
            ...
            <?php if (!empty($_GET['notif'])) { ?>
                <?php if ($_GET['notif'] == "tambahkosong") { ?>
                    <div class="alert alert-danger" role="alert">
                        Maaf semua data penerbit wajib di isi
                    </div>
                <?php } ?>
            <?php } ?>
        </div>
        <form action="index.php?include=konfirmasi-tambah-penerbit" method="post" class="form-horizontal">
            <div class="card-body">
                <div class="form-group row">
                    <label for="tag" class="col-sm-3 col-form-label">Penerbit</label>
                    <div class="col-sm-7">
                        <input name="penerbit" type="text" class="form-control" id="tag" value="">
                    </div>
                </div>
                <div class="form-group row">
