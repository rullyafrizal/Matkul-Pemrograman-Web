...
<section class="content">
    ...
    <div class="card card-info">
        ...
        <div class="col-sm-10">
            <?php
            if (!empty($_GET['notif'])) {
                if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "kategoribuku") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data kategori buku wajib di isi</div>';
                } else if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "judul") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data judul wajib di isi</div>';
                } else if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "pengarang") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data pengarang wajib di isi</div>';
                } else if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "penerbit") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data penerbit wajib di isi</div>';
                } else if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "tahunterbit") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data tahun terbit wajib di isi</div>';
                } else if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "tag") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data tag wajib di isi</div>';
                } else if ($_GET['notif'] == "editkosong" && $_GET['jenis'] == "cover") {
                    echo '<div class="alert alert-danger" role="alert">
                  Maaf data cover wajib di isi</div>';
                }
            }
            ?>
        </div>
