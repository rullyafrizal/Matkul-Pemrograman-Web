...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Tambah Kategori Buku
            </h3>
            <div class="card-tools">
                <a href="index.php?include=kategori-buku" class="btn btn-sm btn-warning float-right">
        ...
        <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-tambah-kategori-buku">
            <div class="card-body">
                <div class="form-group row">
                    <label for="kategoribuku" class="col-sm-3 col-form-label">
                        Kategori Buku</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="kategoribuku"
                               name="kategori_buku" value="">
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
