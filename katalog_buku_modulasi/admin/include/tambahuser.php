    ...
    <div class="card card-info">
        ...
        <div class="col-sm-10">
            ...
            if (!empty($_GET['notif'])) {
                ...
                } else if ($_GET['notif'] == "passwordKosong") {
                    echo '<div class="alert alert-danger" role="alert">
                          Maaf data password wajib di isi</div>';
                } else if ($_GET['notif'] == "levelKosong") {
                    echo '<div class="alert alert-danger" role="alert">
                          Maaf data level wajib di isi</div>';
                } else if ($_GET['notif'] == "formatSalah") {
                    echo '<div class="alert alert-danger" role="alert">
                          Maaf format foto tidak sesuai</div>';
                }
            }
            ?>
        </div>
        <form action="index.php?include=konfirmasi-tambah-user" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="card-body">
