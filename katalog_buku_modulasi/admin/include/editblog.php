...
if (isset($_GET['data'])) {
    ...
    //get data blog
    $sql_m = "SELECT `judul`,`isi`, `id_kategori_blog` FROM `blog` WHERE `id_blog`='$id_blog'";
    $query_m = mysqli_query($koneksi, $sql_m);

    while ($data_m = mysqli_fetch_row($query_m)) {
        $judul = $data_m[0];
        $isi = $data_m[1];
        $id_kategori_blog = $data_m[2];
    }
}
?>
...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Edit Data Blog
            </h3>
