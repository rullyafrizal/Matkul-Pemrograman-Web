                ...
                while ($data_b = mysqli_fetch_row($query_k)) {
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a href="javascript:if(confirm('Anda yakin ingin menghapus konten <?php echo $judul; ?>?')) window.location.href = 'index.php?include=konten&aksi=hapus&data=<?php echo $id_konten; ?>&notif=hapusberhasil'"
