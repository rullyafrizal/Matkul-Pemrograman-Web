...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Edit Penerbit
            </h3>
        ...
        <form action="index.php?include=konfirmasi-edit-penerbit" method="post" class="form-horizontal">
            <div class="card-body">
            ...
            <div class="card-footer">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-info float-right"><i class="fas fa-save"></i> Simpan
                    </button>
                </div>
            </div>
            <!-- /.card-footer -->
